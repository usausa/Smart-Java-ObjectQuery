 ...
 * @param <TSource>
 */
public class ExpectIterator<TSource> implements Iterator<TSource> {
     ...
     * @param comparator
     */
    public ExpectIterator(final Iterator<TSource> source, final Iterator<TSource> second, final Comparator<TSource> comparator) {
        this.source = source;
